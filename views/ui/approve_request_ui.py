...
################################################################################
## Form generated from reading UI file 'approve_request.ui'
##
...
class Ui_ApproveRequest(object):
    def setupUi(self, ApproveRequest):
        if not ApproveRequest.objectName():
            ApproveRequest.setObjectName(u"ApproveRequest")
        ApproveRequest.resize(655, 499)
        self.verticalLayout = QVBoxLayout(ApproveRequest)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.widget = QWidget(ApproveRequest)
...
"}")
        ...
        self.frame_group = QFrame(ApproveRequest)
        ...
        self.retranslateUi(ApproveRequest)

        QMetaObject.connectSlotsByName(ApproveRequest)
    # setupUi

    def retranslateUi(self, ApproveRequest):
        ApproveRequest.setWindowTitle(QCoreApplication.translate("ApproveRequest", u"Form", None))
        self.btn_add_group.setText(QCoreApplication.translate("ApproveRequest", u"Th\u00eam Nh\u00f3m", None))
