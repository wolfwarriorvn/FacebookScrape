...
################################################################################
## Form generated from reading UI file 'page_add.ui'
##
...
class Ui_PageAdd(object):
    def setupUi(self, PageAdd):
        if not PageAdd.objectName():
            PageAdd.setObjectName(u"PageAdd")
        PageAdd.resize(485, 267)
        PageAdd.setStyleSheet(u"* {\n"
"	font: 11pt \"Segoe UI\";\n"
"}\n"
"QTextEdit {\n"
...
"}")
        self.verticalLayout_3 = QVBoxLayout(PageAdd)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.label = QLabel(PageAdd)
        ...
        self.page_name = QLineEdit(PageAdd)
        ...
        self.lb_show_msg = QLabel(PageAdd)
        ...
        self.btn_save = QPushButton(PageAdd)
...
"}")
        ...
        self.retranslateUi(PageAdd)

        QMetaObject.connectSlotsByName(PageAdd)
    # setupUi

    def retranslateUi(self, PageAdd):
        PageAdd.setWindowTitle(QCoreApplication.translate("PageAdd", u"Th\u00eam Page", None))
        self.label.setText(QCoreApplication.translate("PageAdd", u"UID:", None))
        self.label_2.setText(QCoreApplication.translate("PageAdd", u"T\u00ean Page", None))
        self.lb_show_msg.setText("")
        self.btn_save.setText(QCoreApplication.translate("PageAdd", u"Th\u00eam", None))
    # retranslateUi
